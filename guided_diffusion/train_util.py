...
import torchvision
import torch
from .myresnet50 import featurepreprocess
...
class TrainLoop:
    ...
    def  run_loop(self):
        ...
        while (
            ...
            try:
                    ...
                    (small_frame, large_frame, small_trace, large_trace)=cond
                    large_trace = large_trace.unsqueeze(1)
                    small_trace = small_trace.unsqueeze(1)
                    final_trace=th.cat((large_trace, small_trace), dim=0)
                    final_frame=th.cat((large_frame, small_frame), dim=0)
                    ...
                    data_iter = iter(self.dataloader)
                    _, cond = next(data_iter)
                    (large_frame, small_frame, large_trace, small_trace)=cond
            ...
            self.run_step(final_frame, final_trace)
    ...
    def forward_backward(self, batch, cond):
        ...
        self.microbatch=self.batch_size*2
